...
</Tippy>`})})]}),t.jsxs("div",{className:"panel",id:"directions",children:[t.jsxs("div",{className:"flex items-center justify-between mb-5",children:[t.jsx("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Placement"}),t.jsx("button",{onClick:()=>{s("code2")},className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",children:t.jsxs("span",{className:"flex items-center",children:[t.jsx(o,{className:"me-2"}),"Code"]})})]}),t.jsx("div",{className:"mb-5",children:t.jsxs("div",{className:"flex flex-wrap justify-center gap-4 w-full",children:[t.jsx(e,{content:"Popover on top",placement:"top",children:t.jsx("button",{type:"button",className:"btn btn-info",children:"Tooltip on top"})}),t.jsx(e,{content:"Popover on left",placement:"left",children:t.jsx("button",{type:"button",className:"btn btn-secondary",children:"Tooltip on left"})}),t.jsx(e,{content:"Popover on bottom",placement:"bottom",children:t.jsx("button",{type:"button",className:"btn btn-warning",children:"Tooltip on bottom"})}),t.jsx(e,{content:"Popover on right",placement:"right",children:t.jsx("button",{type:"button",className:"btn btn-danger",children:"Tooltip on right"})})]})}),n.includes("code2")&&t.jsx(a,{children:t.jsx("pre",{children:`import Tippy from '@tippyjs/react';
import 'tippy.js/dist/tippy.css';
...
</Tippy>`})})]}),t.jsxs("div",{className:"panel lg:row-start-1 lg:col-start-2",id:"dismissible",children:[t.jsxs("div",{className:"flex items-center justify-between mb-5",children:[t.jsx("h5",{className:"font-semibold text-lg dark:text-white-light",children:"HTML"}),t.jsx("button",{onClick:()=>{s("code3")},className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",children:t.jsxs("span",{className:"flex items-center",children:[t.jsx(o,{className:"me-2"}),"Code"]})})]}),t.jsx("div",{className:"mb-5",children:t.jsx("div",{className:"flex justify-center gap-4 w-full",children:t.jsx(e,{content:t.jsx("strong",{children:"Bolded content"}),children:t.jsx("button",{type:"button","data-dismissable":"true",className:"btn btn-dark",children:"Tooltip on HTML"})})})}),n.includes("code3")&&t.jsx(a,{children:t.jsx("pre",{children:`import Tippy from '@tippyjs/react';
import 'tippy.js/dist/tippy.css';
...
</Tippy>`})})]}),t.jsxs("div",{className:"panel lg:col-span-2",id:"colors",children:[t.jsxs("div",{className:"flex items-center justify-between mb-5",children:[t.jsx("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Colors"}),t.jsx("button",{className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",onClick:()=>{s("code5")},children:t.jsxs("span",{className:"flex items-center",children:[t.jsx(o,{className:"me-2"}),"Code"]})})]}),t.jsx("div",{className:"mb-5",children:t.jsxs("div",{className:"flex flex-wrap justify-center gap-4 w-full",children:[t.jsx(e,{content:"Primary",theme:"primary",children:t.jsx("button",{type:"button",className:"btn btn-primary",children:"Primary"})}),t.jsx(e,{content:"Success",theme:"success",children:t.jsx("button",{type:"button",className:"btn btn-success",children:"Success"})}),t.jsx(e,{content:"info",theme:"info",children:t.jsx("button",{type:"button",className:"btn btn-info",children:"Info"})}),t.jsx(e,{content:"danger",theme:"danger",children:t.jsx("button",{type:"button",className:"btn btn-danger",children:"Danger"})}),t.jsx(e,{content:"warning",theme:"warning",children:t.jsx("button",{type:"button",className:"btn btn-warning",children:"Warning"})}),t.jsx(e,{content:"secondary",theme:"secondary",children:t.jsx("button",{type:"button",className:"btn btn-secondary",children:"Secondary"})}),t.jsx(e,{content:"dark",theme:"dark",children:t.jsx("button",{type:"button",className:"btn btn-dark",children:"Dark"})})]})}),n.includes("code5")&&t.jsx(a,{children:t.jsx("pre",{children:`import Tippy from '@tippyjs/react';
import 'tippy.js/dist/tippy.css';
